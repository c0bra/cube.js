...
To submit a job, send a `POST` request with a `selector` object. The response will
include the `jobId` of the submitted job.
...
| Parameter            | Description                                         | Required |
|----------------------|-----------------------------------------------------|----------|
| `selector.request`   | A request ID                                        | ❌        |
| `selector.context`   | The context of the pre-aggregation build to look up | ✅        |
| `selector.preagg`    | The name of the pre-aggregation                     | ✅        |
| `selector.table`     | The name of the table in the data source            | ✅        |
| `selector.target`    | XXX                                                 | ✅        |
| `selector.structure` | XXX                                                 | ✅        |
| `selector.content`   | XXX                                                 | ✅        |
| `selector.updated`   | XXX                                                 | ✅        |
| `selector.key`       | XXX                                                 | ✅        |
